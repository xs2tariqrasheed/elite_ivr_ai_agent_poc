...
PROMPT_FOR_PICKUP_DATE = (
    "[politely] Okay, What is the pickup date for this reservation?"
)

PROMPT_FOR_PICKUP_TIME = (
    "[politely] and, What is the pickup time?"
)
...
message_to_say = PROMPT_FOR_PICKUP_TIME
