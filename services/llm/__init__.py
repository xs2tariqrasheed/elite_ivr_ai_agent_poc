...
``extract_pickup_date_time``, and ``classify_intent``. Each asks the
LLM for a deterministic answer and falls back gracefully whenever the
model declines or returns junk.
"""
